 ...
 * @file ris_protocol.h
 * @author GORY
 * @source Yichao Zhang (unitree@qq.com)
 * @brief Go-M8010-6关节电机驱动精简通讯指令集
 * @version 
 * @date 2025-07-23
 * 
 ...
 * 
 * @file ris_protocol.h
 * @brief About Motor mode control
 * @brief 电机模式控制信息
 *
 */
typedef struct
{
    uint8_t id     :2;      			// 电机ID: 0,1...,13,14 15表示向所有电机广播数据(此时无返回)
 ...
 * 
 * @file ris_protocol.h
 * @brief About Motor state control
 * @brief 电机状态控制信息
 *
 */
typedef struct
